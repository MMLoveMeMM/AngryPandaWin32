...
int format::mp42avi(const std::string& mp4path, const std::string& avipath)
{
	...
	int ret, i;
	int frame_index = 0;
	in_filename = mp4path.c_str();//Input file URL
	out_filename = avipath.c_str();//Output file URL
